...
from OPENtransformer.arm64_engine.core.asm.kernels.logger import log_info, log_error
...
def get_kernel_code():
    """Returns the ARM assembly code for tokenizer kernel."""
    return tokenizer_kernel_code
